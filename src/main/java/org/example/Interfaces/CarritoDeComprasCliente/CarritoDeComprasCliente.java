...
public class CarritoDeComprasCliente extends javax.swing.JPanel {
    ...
    private void txtApellidoDelClienteActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void BotonObtenerDatosDelClienteActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void txtNombreClienteActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void txtTelefonoDelClienteActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void txtEmailDelClienteActionPerformed(java.awt.event.ActionEvent evt) {
    }
